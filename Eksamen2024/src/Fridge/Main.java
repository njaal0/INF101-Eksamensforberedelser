...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Tests that exception is thrown when attempting to remove item from empty
        // fridge.
        if (takeOutFromEmptyFridgeTest())
            numberOfTestsPassed++;
